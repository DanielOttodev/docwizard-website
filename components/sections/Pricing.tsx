...
const PLANS = [
  ...
  },
  {
    ...
    priceSuffix: "/mo",
    note: "billed monthly",
    features: ["500 documents / month", "Unlimited templates", "API access", "Watermark-free previews","$0.10 / document overage"],
    cta: "Get started",
  ...
  },
  {
    ...
    priceSuffix: "/mo",
    note: "billed monthly",
    features: ["5,000 documents / month", "Unlimited templates", "Priority support", "Higher rate limits" , "$0.04 / document overage"],
    cta: "Get started",
    ctaVariant: "btn-outline",
    featured: false,
  },
